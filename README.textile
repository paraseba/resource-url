...
This will expand to <code>/home/en/?order=by+date&page=4#post-list</code>
...
Now <code>url-for</code> will dispatch to the corresponding URL generating
function:
...
using a keyword: <code>(polymorphic-url url-for (by-member :tag))</code>
